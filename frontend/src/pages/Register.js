...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-brand-gradient-soft flex items-center justify-center p-4 sm:p-6">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="relative w-full max-w-md">
        <div className="flex flex-col items-center mb-5 sm:mb-6">
          <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-gradient-to-br bg-brand-gradient flex items-center justify-center shadow-lg shadow-emerald-500/30 mb-2">
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-5 sm:p-7 shadow-xl shadow-slate-200/60" data-testid="register-card">
          ...
          <form onSubmit={handleSubmit} className="mt-5 sm:mt-6 space-y-4">
            <div>
              ...
              <div className="relative mt-1.5">
                <Ticket size={18} weight="duotone" className="absolute left-3.5 top-1/2 -translate-y-1/2 text-primary" />
                <Input
                  type="text"
            ...
            <div>
              ...
              <div className="relative mt-1.5">
                <User size={18} weight="duotone" className="absolute left-3.5 top-1/2 -translate-y-1/2 text-primary" />
                <Input
                  type="text"
            ...
            <div>
              ...
              {confirmPassword && (
                <p className={`text-[11px] font-medium mt-1 ${password === confirmPassword ? 'text-primary' : 'text-rose-600'}`}>
            ...
            <Button
              type="submit"
              className="w-full h-12 rounded-xl font-bold text-white btn-brand  shadow-lg shadow-emerald-500/25 transition-all active:scale-[0.98]"
              disabled={isLoading}
          ...
          <div className="mt-5 text-center text-sm text-slate-600">
            Already registered?{' '}
            <Link to="/login" className="text-primary hover:text-emerald-700 font-bold" data-testid="login-link">
              Log in
            </Link>
          </div>
        </div>
